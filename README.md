<img width="1310" height="1002" alt="image" src="https://github.com/user-attachments/assets/fcb01fa7-fce5-4a98-8c7b-581e16618181" />
...
```
Home → Mix Ingredients → Mixer → Transport → Fill → Transport → Label
         ↑                                                         |
         └──────────── (repeat until 10 bottles) ─────────────────┘
                                                  ↓
                                          Filling Complete → back to Home
```
...
Project structure
```
├── TIA_Project/        — TIA Portal project files
├── SCADA/              — HMI screens and configuration
├── Docs/               — Lab guide and wiring diagrams
└── README.md
```
---
Key tags
A few of the more important PLC tags used throughout the program:
...
Compile everything: right-click the CPU → Compile → Hardware and software
Download to the PLC
Open the SCADA screen and hit Start
